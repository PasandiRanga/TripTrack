            ...
            <?php if (in_array($userRole, ["RegisteredUser"])): ?>
                ...
                <div class="notification-container">
                        <div class="bell-icon" id="bell-icon">
                            ...
                            <span class="badge" id="notification-count"><?php echo count(array_filter($notifications, function($n) { return !$n['is_read']; })); ?></span>                        </div>
                        <div class="notification-box" id="notification-box">
                            <h3>Notifications</h3>
                            <div class="notification-list" id="notification-list">
                                <?php if (!empty($notifications)): ?>
                                    <?php foreach ($notifications as $notification): ?>
                                        <div class="notifi-item <?php echo $notification['is_read'] ? 'read' : 'unread'; ?>" data-notification-id="<?php echo $notification['id']; ?>">                                            <div class="notification-header">
