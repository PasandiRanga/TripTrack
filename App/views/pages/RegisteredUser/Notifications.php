...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/CSS/RegisteredUser/Notification.css?v=<?php echo time(); ?>">
...
<body>
    ...
    $data = [
        ...
        'currentMethod' => 'notification', // Adjust this based on the method
        'userRole' => $userRole
    ];
    ?>
