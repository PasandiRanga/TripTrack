...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/CSS/RegisteredUser/searchbus.css?v=<?php echo time(); ?>">
...
<body>
    ...
    $data = [
        ...
        'currentMethod' => 'searchBus', // Adjust this based on the method
        'userRole' => $userRole
    ];
    ?>
